...
1. Open a [discussion](https://github.com/orgs/DazzleNodes/discussions) describing the workflow problem
2. Explain current workaround (how many nodes it takes now, ex. "I need 8 nodes to do X, could we make it 1 node?")
3. Describe proposed solution (how one node would solve it)
4. Provide example use cases (ex. "This error happens constantly in Y workflow, can we prevent it?")
...
- **[DazzleML](https://github.com/DazzleML)** - More AI tools including ComfyUI Triton installer
